// constants/permission-schema.ts
import {
  PermissionSchema,
  PermissionValue,
  TeamRole,
...
import {
  ...
  generateLeadPermissions,
  generateMentorPermissions,
  generateStudentLeaderPermissions,
...
export const defaultRolePermissions: Record<TeamRole, PermissionValue> = {
  Owner: generateFullPermissions(),
  Admin: generateFullPermissions(),
  Lead: generateLeadPermissions(),
  Mentor: generateMentorPermissions(),
  "Student Leader": generateStudentLeaderPermissions(),
  Member: generateDefaultPermissions(),
};
